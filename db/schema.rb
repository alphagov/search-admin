...
ActiveRecord::Schema[8.0].define(version: 2025_02_09_152053) do
  ...
  create_table "serving_configs", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.boolean "users_can_assign_controls", null: false, comment: "Whether or not users can assign controls to this serving config in the UI"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
