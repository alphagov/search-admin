RSpec.describe "Controls", type: :system do
  ...
  scenario "Managing boost controls" do
    ...
    and_i_submit_the_form_with_invalid_boost_control_details
    then_i_see_validation_errors

    when_i_submit_the_form_with_valid_boost_control_details
  ...
  scenario "Managing filter controls" do
    ...
    and_i_submit_the_form_with_invalid_filter_control_details
    then_i_see_validation_errors

    when_i_submit_the_form_with_valid_filter_control_details
    then_my_control_has_been_created
  ...
  def and_i_submit_the_form_with_invalid_boost_control_details
    fill_in "Name", with: ""
    fill_in "Filter expression", with: ""
    fill_in "Boost factor", with: "42"

    click_button "Save control"
  end

  def and_i_submit_the_form_with_invalid_filter_control_details
    fill_in "Name", with: ""
    fill_in "Filter expression", with: ""
  ...
  def when_i_submit_the_form_with_valid_boost_control_details
  ...
  def when_i_submit_the_form_with_valid_filter_control_details
  ...
  def when_i_submit_the_form_with_updated_boost_control_details
  ...
  def when_i_submit_the_form_with_updated_filter_control_details
